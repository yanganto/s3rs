...
{0} {1} {2}/{3}
	...
	for secret phraces example, you can use a sentence to be the secret key \"You are the apple of my eye\"
...
{0} {5} {6}
	...
	if there is any file with the same name, it will be overwrite
